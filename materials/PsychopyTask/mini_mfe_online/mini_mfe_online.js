...
function redCap1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of redCap1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function errorNumbersRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of errorNumbersComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function errorPercentageRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of errorPercentageComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function redCap2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of redCap2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function redCap3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of redCap3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
