...
main_dir = '/Users/kihossei/Documents/GitHub/memory-for-error-dataset/materials/experiments/mini_mfe_online/img';
...
for jaguar=1:13 % 5 of these files will be for the main blocks. The last one with 20 trials will be the practice block.
    if jaguar==13
...
half_surp_table1 = surpriseTable(1:(nRows_surpList/8),:);
writetable(half_surp_table1, "half_surp_table1.csv")

half_surp_table2 = surpriseTable((nRows_surpList/8)+1:2*(nRows_surpList/8),:);
writetable(half_surp_table2, "half_surp_table2.csv")

half_surp_table3 = surpriseTable((2*(nRows_surpList/8))+1:3*(nRows_surpList/8),:);
writetable(half_surp_table3, "half_surp_table3.csv")

half_surp_table4 = surpriseTable((3*(nRows_surpList/8))+1:4*(nRows_surpList/8),:);
writetable(half_surp_table4, "half_surp_table4.csv")

half_surp_table5 = surpriseTable((4*(nRows_surpList/8))+1:5*(nRows_surpList/8),:);
writetable(half_surp_table5, "half_surp_table5.csv")

half_surp_table6 = surpriseTable((5*(nRows_surpList/8))+1:6*(nRows_surpList/8),:);
writetable(half_surp_table6, "half_surp_table6.csv")

half_surp_table7 = surpriseTable((6*(nRows_surpList/8))+1:7*(nRows_surpList/8),:);
writetable(half_surp_table7, "half_surp_table7.csv")

half_surp_table8 = surpriseTable((7*(nRows_surpList/8))+1:8*(nRows_surpList/8),:);
